...
Abstract class Add_Counselors{
    ...
    function __construct(){
        ...
        add_action('delete_post',array($this,"delete_counselor"));
    }

    function create_custom_post_type() {
        $labels = array(
            'name' => _x( 'Counselors', 'Post Type General Name', 'textdomain' ),
            'singular_name' => _x( 'Customer Option', 'Post Type Singular Name', 'textdomain' ),
            'menu_name' => _x( 'Counselors', 'Admin Menu text', 'textdomain' ),
            'name_admin_bar' => _x( 'Counselors', 'Add New on Toolbar', 'textdomain' ),
            ...
            'view_items' => __( 'View Counselors', 'textdomain' ),
            ...
            'items_list' => __( 'Counselors list', 'textdomain' ),
            'items_list_navigation' => __( 'Counselors list navigation', 'textdomain' ),
            'filter_items_list' => __( 'Filter Counselors list', 'textdomain' ),
        );
        $args = array(
    ...
    Abstract function delete_counselor($post_id);
}