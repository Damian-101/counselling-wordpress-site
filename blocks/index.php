...
class Cs_Blocks_Config {
    ...
    function frontend_assets(){
        ...
        wp_enqueue_script("articals-block-class",plugin_dir_url(__FILE__) . "src/articals-block/js/class-all-articles.js",array());
        wp_enqueue_script("articals-block-js",plugin_dir_url(__FILE__) . "src/articals-block/js/articals-block.js",array());
    }
